      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <header className="mb-12">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300">
            Vamos ler juntos a <strong>2ª edição</strong> do clássico{" "}
            <em>DDIA</em>, capítulo a capítulo, no ritmo da comunidade. Um
            mergulho profundo em sistemas distribuídos confiáveis, escaláveis e
            fáceis de manter.
          </p>
        </header>
        ...
        <section className="mb-12 bg-white dark:bg-gray-800 rounded-lg shadow-xs border border-gray-200 dark:border-gray-700 p-8">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            <p>
              ...
              (carinhosamente conhecido como <strong>DDIA</strong>) é uma das
              referências mais respeitadas sobre arquitetura de sistemas de
              dados. Escrito por <strong>Martin Kleppmann</strong>, com{" "}
              <strong>Chris Riccomini</strong>&nbsp;como coautor nesta 2ª
              edição, e publicado pela O&apos;Reilly, o livro explica os
              princípios fundamentais por trás de sistemas{" "}
              <em>confiáveis, escaláveis e fáceis de manter</em>.
            </p>
            <p>
              Ao longo dos capítulos, o livro percorre modelos de dados,
              armazenamento e recuperação, codificação e evolução de dados,
              replicação, particionamento (sharding), transações, os desafios
              dos sistemas distribuídos, consistência e consenso, além de
              processamento em batch e em streaming. É leitura obrigatória para
          ...
          <ul className="space-y-4">
            <li className="flex items-start gap-3">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                <strong>Um encontro por capítulo.</strong> Cada sessão é
                dedicada a um capítulo do livro, do começo ao fim, na ordem da
                obra.
              </p>
            </li>
            <li className="flex items-start gap-3">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                <strong>Ritmo quinzenal.</strong> Os encontros acontecem a cada
                duas semanas, dando tempo de sobra para ler com calma e trocar
                ideias.
              </p>
            </li>
            <li className="flex items-start gap-3">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                <strong>Em ordem, do início ao fim.</strong> O primeiro encontro
                cobre o Capítulo 1, o segundo cobre o Capítulo 2, e assim por
                diante até concluirmos o livro.
              </p>
            </li>
            <li className="flex items-start gap-3">
              <span className="flex-shrink-0 mt-1 flex items-center justify-center h-6 w-6 rounded-full bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-300 text-sm font-semibold">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                <strong>Discussão aberta.</strong> Cada sessão é uma conversa:
                dúvidas, experiências reais e debate sobre os trade-offs
            ...
            <li className="flex items-start gap-3">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                <strong>Encontros gravados.</strong> Os encontros são gravados
                e, depois, publicados no{" "}
                <a
            ...
            <li className="flex items-start gap-3">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                <strong>Começamos em 15 de junho de 2026.</strong> O primeiro
                encontro (Capítulo 1) acontece no dia 15 de junho. Marque na
                agenda e venha desde o início!
              </p>
            </li>
          </ul>
        </section>
        ...
        <section className="mb-12 rounded-lg bg-blue-600 dark:bg-blue-700 p-8 text-center shadow-md">
          ...
          <p className="text-blue-100 mb-6 max-w-2xl mx-auto">
            Toda a conversa do Book Club, antes, durante e depois dos encontros,
