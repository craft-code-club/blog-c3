              ...
              <div className="md:hidden">
                ...
                <div className="hidden peer-checked:block border-t border-gray-200 dark:border-gray-700">
                  <div className="flex flex-col space-y-4 px-2 py-4">
                    ...
                    <Link href="/book-clubs/designing-data-intensive-applications" className="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors font-medium">Clube do Livro</Link>
