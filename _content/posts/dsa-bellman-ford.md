...
graph LR
  ...
  E -->|-5| C
```
![DSA Bellman Ford No Negative Cycles](/posts/dsa-bellman-ford-no-negative-cycles.png)
...
graph LR
  ...
  E -->|-9| C
```
![DSA Bellman Ford with Negative Cycles](/posts/dsa-bellman-ford-with-negative-cycles.png)
